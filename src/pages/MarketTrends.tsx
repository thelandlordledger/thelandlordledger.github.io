...
import { TrendingUp, TrendingDown, ArrowRight, Calendar, MapPin, DollarSign, Home, Building2, BarChart3 } from "lucide-react";
        ...
        <section className="py-20 bg-subtle-gradient relative overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-6 text-center">
            ...
            <p className="font-secondary text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              Real-time analysis of real estate market movements, regional dynamics, and emerging opportunities shaping investment strategies
            </p>
